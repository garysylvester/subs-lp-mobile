...
export class ButtonHollowIcon extends React.Component<Props> {
    ...
    render() {
        return (
            <ButtonHI isEnabled={this.props.isEnabled} size={this.props.size} onClick={this.props.onClick}>
