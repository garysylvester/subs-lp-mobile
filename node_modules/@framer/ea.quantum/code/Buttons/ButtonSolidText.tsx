...
const ButtonST = styled.button`
    ...
    ${props =>
        ...
        css`
            .buttonInner {
                &:after {
                    background: ${tokens.ColorButton.solid};
                    border: solid 2px ${tokens.ColorButton.solid};
                    transition: all ${tokens.AnimationTimeDefault.average} ${tokens.AnimationEasing.standard};
                }
            }
            ...
            &:focus {
                .buttonInner {
                    &:after {
                        border: solid 2px ${tokens.ColorNeutral._0};
                        background: ${tokens.ColorButton.solid};
                    }
                }
            }
    ...
    ${props =>
        ...
        css`
            ...
            .buttonInner {
                opacity: 0.2;
                &:after {
                    background: ${tokens.ColorNeutral._400};
...
export class ButtonSolidText extends React.Component<Props> {
