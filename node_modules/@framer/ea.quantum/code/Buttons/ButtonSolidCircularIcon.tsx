...
export class ButtonSolidCircularIcon extends React.Component<Props> {
    ...
    render() {
        return (
            <ButtonSCI isEnabled={this.props.isEnabled} size={this.props.size} onClick={this.props.onClick}>
